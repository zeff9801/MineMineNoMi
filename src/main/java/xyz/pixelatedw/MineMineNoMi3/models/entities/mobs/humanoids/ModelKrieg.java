...
public class ModelKrieg extends ModelBiped
{
	// fields
	ModelRenderer head;
	ModelRenderer body;
	...
	public ModelKrieg()
	{
		...
		Shape1.addBox(-1F, 8F, -8F, 1, 1, 21);
		Shape1.setRotationPoint(-5F, 2F, 0F);
		Shape1.setTextureSize(64, 64);
		Shape1.mirror = true;
		setRotation(Shape1, 0F, 0F, 0F);
		Shape2 = new ModelRenderer(this, 23, 32);
		Shape2.addBox(-2F, 4.5F, -16F, 3, 8, 8);
		Shape2.setRotationPoint(-5F, 2F, 0F);
		Shape2.setTextureSize(64, 64);
		Shape2.mirror = true;
		setRotation(Shape2, 0F, 0F, 0F);
		Shape3 = new ModelRenderer(this, 0, 32);
		Shape3.addBox(-1F, 6F, -19F, 1, 5, 5);
