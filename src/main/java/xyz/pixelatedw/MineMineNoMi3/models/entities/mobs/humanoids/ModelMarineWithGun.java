...
public class ModelMarineWithGun extends ModelBiped
{
	...
	public ModelMarineWithGun()
	{
		...
		Shape1.addBox(-2F, 7F, -3F, 1, 2, 5);
		Shape1.setRotationPoint(-5F, 2F, 0F);
		Shape1.setTextureSize(64, 64);
		Shape1.mirror = true;
		setRotation(Shape1, 0F, 0F, 0F);
		Shape2 = new ModelRenderer(this, 16, 32);
		Shape2.addBox(-2.5F, 6F, -5F, 2, 7, 2);
		Shape2.setRotationPoint(-5F, 2F, 0F);
		Shape2.setTextureSize(64, 64);
		Shape2.mirror = true;
		setRotation(Shape2, 0F, 0F, 0F);
		Shp1 = new ModelRenderer(this, 32, 0);
		Shp1.addBox(0F, 0F, 0F, 8, 1, 2);
		Shp1.setRotationPoint(-4F, -6F, -6F);
		Shp1.setTextureSize(64, 64);
		Shp1.mirror = true;
		setRotation(Shp1, 0F, 0F, 0F);
	}
