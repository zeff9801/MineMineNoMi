...
public class ModelPearl extends ModelBiped
{
	// fields
	ModelRenderer head;
	ModelRenderer body;
	...
	public ModelPearl()
	{
		...
		Shape1.addBox(-6F, 0F, -5F, 12, 14, 3);
		Shape1.setRotationPoint(0F, 0F, 0F);
		Shape1.setTextureSize(64, 64);
		Shape1.mirror = true;
		setRotation(Shape1, 0F, 0F, 0F);
		Shape2 = new ModelRenderer(this, 32, 0);
		Shape2.addBox(-5F, 1F, -4F, 2, 7, 7);
		Shape2.setRotationPoint(-5F, 2F, 0F);
		Shape2.setTextureSize(64, 64);
		Shape2.mirror = true;
		setRotation(Shape2, 0F, 0F, 0F);
		Shape3 = new ModelRenderer(this, 32, 0);
		Shape3.addBox(3F, 1F, -4F, 2, 7, 7);
		Shape3.setRotationPoint(5F, 2F, 0F);
		Shape3.setTextureSize(64, 64);
		Shape3.mirror = true;
		setRotation(Shape3, 0F, 0F, 0F);
		Shape4 = new ModelRenderer(this, 30, 32);
		Shape4.addBox(-2F, 4F, -4F, 4, 4, 2);
		Shape4.setRotationPoint(-2F, 12F, 0F);
		Shape4.setTextureSize(64, 64);
		Shape4.mirror = true;
		setRotation(Shape4, 0F, 0F, 0F);
		Shape6 = new ModelRenderer(this, 30, 32);
		Shape6.addBox(-2F, 4F, -4F, 4, 4, 2);
		Shape6.setRotationPoint(2F, 12F, 0F);
		Shape6.setTextureSize(64, 64);
		Shape6.mirror = true;
		setRotation(Shape6, 0F, 0F, 0F);
		Shape5 = new ModelRenderer(this, 30, 38);
		Shape5.addBox(-3F, -13F, -3F, 6, 5, 6);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		Shape3.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;

		Shape5.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
		Shape4.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * 1.0F * f1;
